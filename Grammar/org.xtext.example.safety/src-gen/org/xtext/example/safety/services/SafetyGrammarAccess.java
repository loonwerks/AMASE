 ...
 * generated by Xtext
 */
package org.xtext.example.safety.services;
...
public class SafetyGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AnnexSubclauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.AnnexSubclause");
	...
	public class SafetyLibraryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.SafetyLibrary");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SafetySubclauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.SafetySubclause");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SafetyContractElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.SafetyContract");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SpecStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.SpecStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FaultSubcomponentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.FaultSubcomponent");
		...
		private final CrossReference cNom_connNamedElementCrossReference_1_5_0 = (CrossReference)cNom_connAssignment_1_5.eContents().get(0);
		private final RuleCall cNom_connNamedElementIDTerminalRuleCall_1_5_0_1 = (RuleCall)cNom_connNamedElementCrossReference_1_5_0.eContents().get(1);
		...
		//nom_conn=[aadl2::NamedElement]
		public Assignment getNom_connAssignment_1_5() { return cNom_connAssignment_1_5; }

		//[aadl2::NamedElement]
		public CrossReference getNom_connNamedElementCrossReference_1_5_0() { return cNom_connNamedElementCrossReference_1_5_0; }

		//ID
		public RuleCall getNom_connNamedElementIDTerminalRuleCall_1_5_0_1() { return cNom_connNamedElementIDTerminalRuleCall_1_5_0_1; }
	...
	public class TemporalConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.TemporalConstraint");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cPermanentKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Keyword cTransientKeyword_1 = (Keyword)cAlternatives.eContents().get(1);
		...
		//'permanent'
		public Keyword getPermanentKeyword_0() { return cPermanentKeyword_0; }

		//'transient'
		public Keyword getTransientKeyword_1() { return cTransientKeyword_1; }
	}

	public class TriggerConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.TriggerCondition");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	public class EqStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.safety.Safety.EqStatement");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.safety.Safety".equals(grammar.getName())) {
				return grammar;
			}
