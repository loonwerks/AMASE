		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEqStatementAccess().getAlternatives(), "rule__EqStatement__Alternatives");
					...
					put(grammarAccess.getEqStatementAccess().getGroup_0(), "rule__EqStatement__Group_0__0");
					put(grammarAccess.getEqStatementAccess().getGroup_0_1(), "rule__EqStatement__Group_0_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_0_1_1(), "rule__EqStatement__Group_0_1_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_0_2(), "rule__EqStatement__Group_0_2__0");
					...
					put(grammarAccess.getEqStatementAccess().getGroup_1_1_1(), "rule__EqStatement__Group_1_1_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_1_2(), "rule__EqStatement__Group_1_2__0");
					put(grammarAccess.getEqStatementAccess().getGroup_2(), "rule__EqStatement__Group_2__0");
					put(grammarAccess.getEqStatementAccess().getGroup_2_1(), "rule__EqStatement__Group_2_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_2_1_1(), "rule__EqStatement__Group_2_1_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_2_2(), "rule__EqStatement__Group_2_2__0");
					...
					put(grammarAccess.getFaultSubcomponentAccess().getExprAssignment_0_6_1(), "rule__FaultSubcomponent__ExprAssignment_0_6_1");
					...
					put(grammarAccess.getFaultSubcomponentAccess().getProbabilityAssignment_3_5(), "rule__FaultSubcomponent__ProbabilityAssignment_3_5");
					put(grammarAccess.getTriggerConditionAccess().getExprListAssignment_0_2(), "rule__TriggerCondition__ExprListAssignment_0_2");
					put(grammarAccess.getTriggerConditionAccess().getExprListAssignment_1_2(), "rule__TriggerCondition__ExprListAssignment_1_2");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_0_1_0(), "rule__EqStatement__LhsAssignment_0_1_0");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_0_1_1_1(), "rule__EqStatement__LhsAssignment_0_1_1_1");
					put(grammarAccess.getEqStatementAccess().getExprAssignment_0_2_1(), "rule__EqStatement__ExprAssignment_0_2_1");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_1_1_0(), "rule__EqStatement__LhsAssignment_1_1_0");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_1_1_1_1(), "rule__EqStatement__LhsAssignment_1_1_1_1");
					put(grammarAccess.getEqStatementAccess().getIntervAssignment_1_2_1(), "rule__EqStatement__IntervAssignment_1_2_1");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_2_1_0(), "rule__EqStatement__LhsAssignment_2_1_0");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_2_1_1_1(), "rule__EqStatement__LhsAssignment_2_1_1_1");
					put(grammarAccess.getEqStatementAccess().getExprListAssignment_2_2_2(), "rule__EqStatement__ExprListAssignment_2_2_2");
