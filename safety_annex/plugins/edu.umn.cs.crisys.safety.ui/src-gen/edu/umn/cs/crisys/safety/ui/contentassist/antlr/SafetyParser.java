 ...
 * generated by Xtext
 */
package edu.umn.cs.crisys.safety.ui.contentassist.antlr;
...
public class SafetyParser extends AbstractPartialContentAssistParser {
	...
	@Override
	protected edu.umn.cs.crisys.safety.ui.contentassist.antlr.internal.InternalSafetyParser createParser() {
		edu.umn.cs.crisys.safety.ui.contentassist.antlr.internal.InternalSafetyParser result = new edu.umn.cs.crisys.safety.ui.contentassist.antlr.internal.InternalSafetyParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSafetyIntervalAccess().getAlternatives(), "rule__SafetyInterval__Alternatives");
					...
					put(grammarAccess.getFaultSubcomponentAccess().getGroup_1_6(), "rule__FaultSubcomponent__Group_1_6__0");
					...
					put(grammarAccess.getTriggerConditionAccess().getGroup(), "rule__TriggerCondition__Group__0");
					put(grammarAccess.getTriggerConditionAccess().getGroup_4(), "rule__TriggerCondition__Group_4__0");
					...
					put(grammarAccess.getSafetyEqStatementAccess().getGroup_0_3(), "rule__SafetyEqStatement__Group_0_3__0");
					...
					put(grammarAccess.getSafetyIntervalAccess().getGroup_0(), "rule__SafetyInterval__Group_0__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_0_0(), "rule__SafetyInterval__Group_0_0__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_1(), "rule__SafetyInterval__Group_1__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_1_0(), "rule__SafetyInterval__Group_1_0__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_2(), "rule__SafetyInterval__Group_2__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_2_0(), "rule__SafetyInterval__Group_2_0__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_3(), "rule__SafetyInterval__Group_3__0");
					put(grammarAccess.getSafetyIntervalAccess().getGroup_3_0(), "rule__SafetyInterval__Group_3_0__0");
					...
					put(grammarAccess.getSpecStatementAccess().getFaultDefNameAssignment_0_5(), "rule__SpecStatement__FaultDefNameAssignment_0_5");
					put(grammarAccess.getSpecStatementAccess().getFaultDefinitionsAssignment_0_7(), "rule__SpecStatement__FaultDefinitionsAssignment_0_7");
					put(grammarAccess.getSpecStatementAccess().getBehaviorAssignment_1_3(), "rule__SpecStatement__BehaviorAssignment_1_3");
					put(grammarAccess.getSpecStatementAccess().getNameAssignment_2_2(), "rule__SpecStatement__NameAssignment_2_2");
					put(grammarAccess.getSpecStatementAccess().getStrAssignment_2_3(), "rule__SpecStatement__StrAssignment_2_3");
					put(grammarAccess.getSpecStatementAccess().getFaultDefinitionsAssignment_2_6(), "rule__SpecStatement__FaultDefinitionsAssignment_2_6");
					put(grammarAccess.getSpecStatementAccess().getSrcFaultListAssignment_3_4(), "rule__SpecStatement__SrcFaultListAssignment_3_4");
					put(grammarAccess.getSpecStatementAccess().getSrcComp_pathAssignment_3_6(), "rule__SpecStatement__SrcComp_pathAssignment_3_6");
					put(grammarAccess.getSpecStatementAccess().getSrcFaultListAssignment_3_7_1(), "rule__SpecStatement__SrcFaultListAssignment_3_7_1");
					put(grammarAccess.getSpecStatementAccess().getSrcComp_pathAssignment_3_7_3(), "rule__SpecStatement__SrcComp_pathAssignment_3_7_3");
					put(grammarAccess.getSpecStatementAccess().getDestFaultListAssignment_3_11(), "rule__SpecStatement__DestFaultListAssignment_3_11");
					...
					put(grammarAccess.getFaultSubcomponentAccess().getNom_connAssignment_0_6_3(), "rule__FaultSubcomponent__Nom_connAssignment_0_6_3");
					put(grammarAccess.getFaultSubcomponentAccess().getNom_connAssignment_1_3(), "rule__FaultSubcomponent__Nom_connAssignment_1_3");
					put(grammarAccess.getFaultSubcomponentAccess().getFault_outAssignment_1_5(), "rule__FaultSubcomponent__Fault_outAssignment_1_5");
					put(grammarAccess.getFaultSubcomponentAccess().getNom_connAssignment_1_6_1(), "rule__FaultSubcomponent__Nom_connAssignment_1_6_1");
					put(grammarAccess.getFaultSubcomponentAccess().getFault_outAssignment_1_6_3(), "rule__FaultSubcomponent__Fault_outAssignment_1_6_3");
					...
					put(grammarAccess.getSafetyEqStatementAccess().getLhs_intAssignment_1_2(), "rule__SafetyEqStatement__Lhs_intAssignment_1_2");
					put(grammarAccess.getSafetyEqStatementAccess().getIntervAssignment_1_4(), "rule__SafetyEqStatement__IntervAssignment_1_4");
					...
					put(grammarAccess.getSafetyIntervalAccess().getLowAssignment_0_0_2(), "rule__SafetyInterval__LowAssignment_0_0_2");
					put(grammarAccess.getSafetyIntervalAccess().getHighAssignment_0_0_4(), "rule__SafetyInterval__HighAssignment_0_0_4");
					put(grammarAccess.getSafetyIntervalAccess().getLowAssignment_1_0_2(), "rule__SafetyInterval__LowAssignment_1_0_2");
					put(grammarAccess.getSafetyIntervalAccess().getHighAssignment_1_0_4(), "rule__SafetyInterval__HighAssignment_1_0_4");
					put(grammarAccess.getSafetyIntervalAccess().getLowAssignment_2_0_2(), "rule__SafetyInterval__LowAssignment_2_0_2");
					put(grammarAccess.getSafetyIntervalAccess().getHighAssignment_2_0_4(), "rule__SafetyInterval__HighAssignment_2_0_4");
					put(grammarAccess.getSafetyIntervalAccess().getLowAssignment_3_0_2(), "rule__SafetyInterval__LowAssignment_3_0_2");
					put(grammarAccess.getSafetyIntervalAccess().getHighAssignment_3_0_4(), "rule__SafetyInterval__HighAssignment_3_0_4");
					...
					put(grammarAccess.getTermExprAccess().getPortAssignment_9_3(), "rule__TermExpr__PortAssignment_9_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			edu.umn.cs.crisys.safety.ui.contentassist.antlr.internal.InternalSafetyParser typedParser = (edu.umn.cs.crisys.safety.ui.contentassist.antlr.internal.InternalSafetyParser) parser;
