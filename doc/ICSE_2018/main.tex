...
\title{ICSEA paper outline}
%


\author{\IEEEauthorblockN{Danielle Stewart}
\IEEEauthorblockA{University of Minnesota\\ Department of Computer
Science and Engineering\\
Email: dkstewar@umn.edu}
\and
\IEEEauthorblockN{Jing (Janet) Liu}
