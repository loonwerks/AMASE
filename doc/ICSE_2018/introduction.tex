...
\danielle{In introduction:
(1) address more about compositonal vs monolithic FT generation, (2) address why AADL FTs using this method is better than what currently exists (either in intro or related work or SOMEWHERE)}
