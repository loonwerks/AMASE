...
\danielle{I double checked the definitions I provide in this section for error, fault, and failure. They do correspond with the defs in ARP documents. I do not however make the distinctions between type 1 and 2. If we want to add this in, we can, but I just combed through the section and edited the parts where I did use the wrong term. We will need to proof read this section a few times I think... }
