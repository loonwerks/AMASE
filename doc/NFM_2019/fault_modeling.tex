...
In the following subsections, we walk through examples of component failure modes to illustrate how a safety engineer can use the Safety Annex to perform these assessments and see how an active fault may or may not cause failure of a component as well as watch the propagation of a failed component through the behavior of the system model without the need for explicit failure propagation.
...
%\subsection{Error propagation of the selector valve component failure}
