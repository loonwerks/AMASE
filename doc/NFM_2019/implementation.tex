...
\janet{The architecture of the Safety Annex is shown in Figure~\ref{fig:plugin-arch}.}
...
\begin{figure}[h!]
	...
	\janet{	\caption{Nominal AGREE Node and Extension with Faults}}
		\label{fig:lustre}
	\end{center}
	\vspace{-0.3in}
\end{figure}
