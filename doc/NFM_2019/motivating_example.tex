 ...
 \janet{J's comments: It was not clear what safety analysis needs were motivated from this WBS example and addressed by our approach. Consider more emphasis on the info that would motivate our approach, less on general description of this example. For example, info such as 29 top level properties, 113 supporting contracts, by themselves alone don't show why we need our approach, but behavioral properties/requirements may.} 
...
\janet{J's comment: The ''following lower level component contracts'' were not described.} 
