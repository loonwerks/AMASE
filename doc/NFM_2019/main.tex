...
\begin{comment}
The accompanying tool support allows investigation of the \emph{implicit} propagation of %failures  
errors from their source to their effect on top level safety properties as well as the modeling of \emph{explicit} %failure
error propagation that is not captured through the behavioral models, e.g., failures correlated due to the physical structure of the system. 
\end{comment}
<<<<<<< HEAD
The accompanying tool support allows investigation of the propagation of errors from their source to their effect on top level safety properties without the need to add separate propagation specifications (\emph{implicit} error propagation); it  also supports describing dependent faults that are not captured through the behavioral models (\emph{explicit} error propagation), e.g., failures correlated due to the physical structure of the system.
=======
The accompanying tool support allows investigation of the propagation of errors from their source to their effect on top level safety properties without the need to add separate propagation specifications; %(\emph{implicit} error propagation)
it  also supports describing dependent faults that are not captured through the behavioral models, %(\emph{explicit} error propagation)
e.g., failures correlated due to the physical structure of the system.
>>>>>>> 468099d25796c50b046ef6cb24f65e4f524490e3
