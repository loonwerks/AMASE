...
\title{The Safety Annex for Architecture Analysis Design and Analysis Language}
%
...
\keywords{Model-based systems engineering, safety analysis, fault analysis, safety engineering}
...
\input{detailed_approach}

%\input{safety_modeling}
