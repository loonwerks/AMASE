...
In Section 2.1, what is the basis for your designation of small, medium, and large systems?  Is it based on the number of lines of software code or what other criteria?

In Section 2.2, you use the term "verification".  I am not sure that how you use this term matches the definition of "verification" in ARP4754A.  It seems to me that in Section 2.2, you would be using the term "validation" based on how that term is defined in ARP4754A.
