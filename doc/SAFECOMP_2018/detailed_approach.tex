...
\begin{figure}[h!]
	\vspace{-0.19in} 
	\begin{center}
		\includegraphics[trim=0 670 -10 70,clip,width=1.3\textwidth]{images/fault_node.pdf}
	\end{center}
	\vspace{-0.4in}
\end{figure}
...
\begin{figure}[h!]
	...
	\begin{center}
		...
		\includegraphics[trim=0 620 0 70,clip,width=1.3\textwidth]{images/pump_fault.pdf}
	\end{center}
	\vspace{-0.40in}
\end{figure}
