...
By performing this fault analysis, it became clear that the design of the system requires redundant sensors in order to prevent this single fault from violating the safety requirement. Redundancy in the BSCU is not sufficient to prevent this catastrophic failure since the electrical pedal position is supplied to the BSCU channels as input (see Figure 28 in AIR6110). Furthermore, the analysis provides a clear counterexample to the invalid top level properties. This makes it possible to trace the actual failure propogation and determine weak points in the system. In terms of the safety analysis process, this corresponds with comparing the analysis results of the SSA with safety requirements of the system. This information can then be used during the next phase of system development. 
