...
%Mike: with regard to the results comments at the end of the QFCS case study, he thinks that we can describe what errors were found and timing for proving them. We can mention that we demonostrated that the initial system was not resilient to Byzantine faults, but with the mitigation we were able to verify that it was.
