 ...
 * </p>
 * <ul>
 *   <li>{@link edu.umn.cs.crisys.safety.safety.EqStatement#getInterv <em>Interv</em>}</li>
 *   <li>{@link edu.umn.cs.crisys.safety.safety.EqStatement#getExprList <em>Expr List</em>}</li>
 * </ul>
 *
...
public interface EqStatement extends FaultSubcomponent, com.rockwellcollins.atc.agree.agree.EqStatement
{
   ...
   * @see edu.umn.cs.crisys.safety.safety.SafetyPackage#getEqStatement_Interv()
  ...
  /**
   * Sets the value of the '{@link edu.umn.cs.crisys.safety.safety.EqStatement#getInterv <em>Interv</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see edu.umn.cs.crisys.safety.safety.SafetyPackage#getEqStatement_ExprList()
   * @model containment="true"
   * @generated
   */
