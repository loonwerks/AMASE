		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEqStatementAccess().getGroup_0_2_1(), "rule__EqStatement__Group_0_2_1__0");
					put(grammarAccess.getEqStatementAccess().getGroup_0_3(), "rule__EqStatement__Group_0_3__0");
					...
					put(grammarAccess.getEqStatementAccess().getGroup_2_6(), "rule__EqStatement__Group_2_6__0");
					...
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_0_2_0(), "rule__EqStatement__LhsAssignment_0_2_0");
					put(grammarAccess.getEqStatementAccess().getLhsAssignment_0_2_1_1(), "rule__EqStatement__LhsAssignment_0_2_1_1");
					put(grammarAccess.getEqStatementAccess().getExprAssignment_0_3_1(), "rule__EqStatement__ExprAssignment_0_3_1");
					put(grammarAccess.getEqStatementAccess().getLhs_intAssignment_1_2(), "rule__EqStatement__Lhs_intAssignment_1_2");
					put(grammarAccess.getEqStatementAccess().getIntervAssignment_1_4(), "rule__EqStatement__IntervAssignment_1_4");
					put(grammarAccess.getEqStatementAccess().getLhs_setAssignment_2_2(), "rule__EqStatement__Lhs_setAssignment_2_2");
					put(grammarAccess.getEqStatementAccess().getL1Assignment_2_5(), "rule__EqStatement__L1Assignment_2_5");
					put(grammarAccess.getEqStatementAccess().getListAssignment_2_6_1(), "rule__EqStatement__ListAssignment_2_6_1");
